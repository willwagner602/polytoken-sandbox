...
RUN microdnf install -y python3 python3-pip python3-pytest git gh jq golang zip podman docker docker-cli moby-engine nodejs npm iproute procps-ng && microdnf clean all
